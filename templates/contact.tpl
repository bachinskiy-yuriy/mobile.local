    ...
    <div class="content-indent">
        <div class="module_address">
            <h3><span><span>Kostya & Co</span></span></h3>
            <div class="boxIndent">
                <div class="wrapper2">
		...
		<br/><br/>							
        <div class="contactcontacts">
            <h3>Написати нам</h3>
            <div class="info"></div>
            <div class="contact-form">
                <form id="contact-form" action="/free_2013_virtuemart_2_0_22_a/index.php/contact" method="post" class="form-validate">
                    <fieldset>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <input type="hidden" name="e62ff44d3966f0b8a19299197b3886ac" value="1" />				
                            </dd>
                        </dl>
                    </fieldset>
                </form>
